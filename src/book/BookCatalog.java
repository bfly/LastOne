...
public class BookCatalog {
	...
	/**
	 * Internal map for storing books where the key is the title and the value is the book.Book object.
	 */
	 ...
	 * Uses book title as key and book.Book itself as value.  If title is null, doesn't add book.Book.
	 * @param book to add
	 */
